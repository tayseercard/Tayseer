...
<div className="min-w-[100vw] flex-shrink-0 flex flex-col items-center justify-center px-5 py-8 space-y-6">
...
<div className="min-w-[100vw] flex-shrink-0 flex flex-col justify-center px-6 py-8">
