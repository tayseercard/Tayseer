...
export default function TayseerLanding() {
  ...
  return (
    <div className="min-h-dvh flex flex-col bg-[var(--bg)] text-[var(--c-text)]" style={paletteVars}>
      {/* ===== HEADER ===== */}
      <header className="sticky top-0 z-50 bg-white/90 backdrop-blur-sm border-b border-[var(--c-secondary)]/20">
        <nav className="max-w-7xl mx-auto flex items-center justify-between px-4 sm:px-6 py-4">
          ...
          <Link href="/icon-192.png" className="flex items-center gap-2">
            <div className="h-8 w-8 rounded-md bg-[var(--c-bank)]" />
      ...
      <main className="flex-1 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <section className="py-24 text-center flex flex-col items-center gap-6">
          ...
          <div className="mt-6 flex flex-col sm:flex-row gap-3 justify-center">
            <Link
              href="/auth/login"
              className="inline-flex items-center justify-center gap-2 rounded-md bg-[var(--c-bank)] text-white px-6 py-3 font-semibold hover:bg-[var(--c-secondary)] transition"
            >
        ...
        <section className="py-20 text-center">
          <div className="bg-[var(--c-bank)] text-white rounded-3xl py-12 px-6 md:px-12 shadow-md">
