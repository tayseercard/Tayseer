...
useEffect(() => {
  // 🧠 Safety: only run if voucher exists
 ...
 async function onActivate() {
  ...
  try {
    ...
    // ✅ If the store entered buyer name or phone, check for existing client
    ...
    // 💾 Update voucher — optimistic guard: only if still blank
