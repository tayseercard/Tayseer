...
const navItems = [
  ...
  { name: 'Users', href: '/superadmin/users', icon: Building2 },
  { name: 'Vouchers', href: '/superadmin/vouchers', icon: Building2 },
    ...
    <div className="min-h-screen flex bg-gray-50 text-gray-800">
      ...
      >
        ...
        <div className="flex items-center justify-between px-4 py-3 border-b border-gray-200">
          <h1 className="text-xl font-semibold text-indigo-600">👑 Superadmin</h1>
      ...
      <div className="flex-1 flex flex-col">
        ...
        <header className="md:hidden flex items-center justify-between p-4 bg-white border-b border-gray-200 shadow-sm">
          ...
          <h2 className="font-semibold text-lg text-indigo-600">Tayseer Admin</h2>
        </header>
